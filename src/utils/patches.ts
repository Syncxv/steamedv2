...
export function canonicalizeReplace(
	replace: string | ReplaceFn,
	pluginName: string
): string | ReplaceFn {
	const self = `Steamed.Plugins.plugins[${JSON.stringify(pluginName)}]`;

	if (typeof replace !== "function") return replace.replaceAll("$self", self);
